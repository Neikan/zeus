              ...
              child: Column(
                children: [
                  ...
                  isVisible
                      ? Column(
                          children: [
                            _Item(value: subscribeData.detailSubscribe.trafficAdditional),
                            _Item(value: subscribeData.detailSubscribe.premium),
                            _Item(value: subscribeData.detailSubscribe.traffic),
                            _Item(value: subscribeData.detailSubscribe.space),
                            _Item(value: subscribeData.detailSubscribe.size),
                            _Item(value: subscribeData.detailSubscribe.channel),
                            _Item(value: subscribeData.detailSubscribe.prioroty),
                            const Visibility(visible: true, child: SizedBox(height: 45)),
                            Visibility(
                              visible: true,
                                ...
                                builder: (context, currentServiceType) {
                                  return ButtonApp(
                                    ...
                                    onTap: () {
                                      ...
                                      Navigator.of(context).push(BuyContentScreen.materialPageRoute(
                                          serviceType: currentServiceType,
                                          subscriptionType: subscribeData.subscriptionType));
                                    },
                                  );
                                },
                              ),
...
class _ItemData extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      width: MediaQuery.of(context).size.width * 0.8 - 92,
      decoration: const BoxDecoration(border: Border(bottom: BorderSide(color: optionalColor))),
      child: Text(
        value,
        style: h3RStyle,
      ),
